...
const World = () => (
    <section className={`${styles.paddings} relative z-10`}>
        <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{once: false, amount: 0.2}} className={`${styles.innerWidth} mx-auto flex flex-col`}>
            ...
            <TitleText title={(<>It's where I share my finished projects, valuable blog posts, and most importantly share knowledge</>)} textStyles="text-center"/>
            <motion.div variants={fadeIn('up', 'tween', 0.1, 1)} className="relative mt-[69px] flex w-full h-[550px]">
                <img src="/map.png" alt="map" className="w-full h-full object-cover"/>
                {/* chararcters on the map */}
