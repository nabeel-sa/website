...
const ExploreCard = ({id, imgUrl, title, index, active, handleClick}) => (
    <motion.div variants={fadeIn('right', 'spring', index * 0.2, 0.5)} className={`relative ${active === id ? 'lg:flex-[4] flex-[10]' : 'lg:flex-[0.6] flex-[2]'} flex items-center justify-center min-w-[170px] h-[700px] transition-[flex] duration-[0.8s] ease-out-flex cursor-pointer`} onClick={() => handleClick(id)}>
        ...
        {active !== id ? (
            ...
            <div className="absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
                ...
                <p className="font-normal text-[16px] leading-[20.16px] text-white uppercase">Contact me</p>
